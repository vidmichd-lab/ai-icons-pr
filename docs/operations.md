...
- по умолчанию каждому новому пользователю доступно 100 генераций на календарный месяц по UTC-месяцу
- `vidmich` не ограничен лимитом
- `vidmich` может менять месячный лимит любого пользователя в `Панели управления`
